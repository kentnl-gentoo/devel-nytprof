 ...
 * contents of NYTProf.xs. Do not edit this file, edit NYTProf.xs instead.
 *
...
XS(XS_DB_DB); /* prototype to pass -Wmissing-prototypes */
XS(XS_DB_DB)
{
    dXSARGS;
    {
...
XS(XS_DB_init); /* prototype to pass -Wmissing-prototypes */
XS(XS_DB_init)
{
    dXSARGS;
    if (items != 0)
	Perl_croak(aTHX_ "Usage: DB::init()");
    {
#line 912 "NYTProf.xs"
		init(aTHX);
#line 932 "NYTProf.c"
...
XS(XS_DB__finish); /* prototype to pass -Wmissing-prototypes */
XS(XS_DB__finish)
{
    dXSARGS;
    if (items != 0)
	Perl_croak(aTHX_ "Usage: DB::_finish()");
...
XS(XS_Devel__NYTProf__Reader_process); /* prototype to pass -Wmissing-prototypes */
XS(XS_Devel__NYTProf__Reader_process)
{
    dXSARGS;
    if (items < 0 || items > 1)
	Perl_croak(aTHX_ "Usage: Devel::NYTProf::Reader::process(file=NULL)");
    {
	char *	file;
	HV *	RETVAL;
...
XS(XS_Devel__NYTProf__Reader_getDatabaseTime); /* prototype to pass -Wmissing-prototypes */
XS(XS_Devel__NYTProf__Reader_getDatabaseTime)
{
    dXSARGS;
    if (items != 0)
	Perl_croak(aTHX_ "Usage: Devel::NYTProf::Reader::getDatabaseTime()");
    {
	IV	RETVAL;
	dXSTARG;

	RETVAL = getDatabaseTime();
...
XS(XS_Devel__NYTProf__Reader_getTicksPerSec); /* prototype to pass -Wmissing-prototypes */
XS(XS_Devel__NYTProf__Reader_getTicksPerSec)
{
    dXSARGS;
    if (items != 0)
	Perl_croak(aTHX_ "Usage: Devel::NYTProf::Reader::getTicksPerSec()");
    {
	IV	RETVAL;
	dXSTARG;

	RETVAL = getTicksPerSec();
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
extern "C"
#endif
XS(boot_Devel__NYTProf); /* prototype to pass -Wmissing-prototypes */
XS(boot_Devel__NYTProf)
{
    dXSARGS;
    char* file = __FILE__;
    ...
    XS_VERSION_BOOTCHECK ;
        ...
        newXS("DB::DB", XS_DB_DB, file);
        newXS("DB::init", XS_DB_init, file);
        newXS("DB::_finish", XS_DB__finish, file);
        newXS("Devel::NYTProf::Reader::process", XS_Devel__NYTProf__Reader_process, file);
        newXS("Devel::NYTProf::Reader::getDatabaseTime", XS_Devel__NYTProf__Reader_getDatabaseTime, file);
        newXS("Devel::NYTProf::Reader::getTicksPerSec", XS_Devel__NYTProf__Reader_getTicksPerSec, file);
    XSRETURN_YES;
}
